...
**Poetry-Specific Workflow**

This script:

1. Installs Poetry within the container environment
2. Delegates to :func:`~aws_lambda_artifact_builder.layer.poetry_builder.build_layer_artifacts_using_poetry_in_local`
3. Executes :class:`~aws_lambda_artifact_builder.layer.poetry_builder.PoetryBasedLambdaLayerLocalBuilder` workflow
