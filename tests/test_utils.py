...
from aws_lambda_artifact_builder.utils import (
...
def test_is_match():
    ...
    assert (
        ...
        is False
    )  # This matches folder/*.py so should be excluded
    ...
    # The function should use Path() constructor which handles OS differences
    assert is_match(["src", "main.py"], ["src/*.py"], []) is True
...
if __name__ == "__main__":
    ...
    run_cov_test(
        __file__,
        "aws_lambda_artifact_builder.utils",
        preview=False,
    )
