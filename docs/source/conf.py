# -*- coding: utf-8 -*-
#
# aws_lambda_artifact_builder documentation build configuration file, created by
...
import aws_lambda_artifact_builder as package
...
# Add data for Jinja2
try:
    from aws_lambda_artifact_builder.docs import doc_data
except:
    doc_data = dict()
